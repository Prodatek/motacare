...
# to any registry) and to install auth-service's actual runtime dependencies —
...
RUN npm install --workspace=apps/auth-service --workspace=packages/shared-types --workspace=packages/shared-utils --omit=dev
