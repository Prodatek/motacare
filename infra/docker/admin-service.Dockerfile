...
# to any registry) and to install admin-service's actual runtime dependencies —
...
RUN npm install --workspace=apps/admin-service --workspace=packages/shared-types --workspace=packages/shared-utils --omit=dev
