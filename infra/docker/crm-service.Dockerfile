# ==============================================
# MOTACARE — CRM Service Dockerfile
...
RUN npm install --workspace=apps/crm-service --workspace=packages/shared-types --workspace=packages/shared-utils
...
# to any registry) and to install crm-service's actual runtime dependencies —
...
COPY --from=builder /app/apps/crm-service/package.json ./apps/crm-service/
